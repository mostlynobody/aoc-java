...
public class DiskFragmenterServiceTest {

    private DiskFragmenterService diskFragmenterService;
    private JsonMapper jsonMapper;

    @BeforeEach
    void setup() {
        diskFragmenterService = new DiskFragmenterService();
    ...
    void testSolve() throws IOException {
        ...
        SolutionJson result = diskFragmenterService.solve(input);
