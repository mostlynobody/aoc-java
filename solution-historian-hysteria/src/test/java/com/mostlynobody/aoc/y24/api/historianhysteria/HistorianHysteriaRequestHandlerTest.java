package com.mostlynobody.aoc.y24.api.historianhysteria;

import com.amazonaws.services.lambda.runtime.events.APIGatewayProxyRequestEvent;
import com.amazonaws.services.lambda.runtime.events.APIGatewayProxyResponseEvent;
import com.mostlynobody.aoc.y24.service.historianhysteria.HistorianHysteriaService;
...
public class HistorianHysteriaRequestHandlerTest {
    ...
    private final HistorianHysteriaService historianHysteriaService = mock(HistorianHysteriaService.class);

    private final HistorianHysteriaRequestHandler functionRequestHandler =
            new HistorianHysteriaRequestHandler(objectMapper, historianHysteriaService);
    ...
    void testExecute_Success() throws IOException {
        ...
        when(historianHysteriaService.solve("testInput")).thenReturn(solutionJson);
        ...
        verify(historianHysteriaService).solve("testInput");
        verify(objectMapper).writeValueAsString(solutionJson);
        verifyNoMoreInteractions(objectMapper, historianHysteriaService);
    }
    ...
    void testExecute_MissingRequestBody() {
        ...
        verifyNoInteractions(objectMapper, historianHysteriaService);
    }
    ...
    void testExecute_MalformedInputJson() throws IOException {
        ...
        verify(historianHysteriaService, never()).solve(anyString());
    ...
    void testExecute_ServiceThrowsException() throws IOException {
        ...
        when(objectMapper.readValue(inputJsonString, InputJson.class)).thenReturn(inputJson);
        when(historianHysteriaService.solve("testInput")).thenThrow(new RuntimeException("Service Failed"));
