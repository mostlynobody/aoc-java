...
class RedNosedReportsRequestHandlerTest {
    ...
    private final RedNosedReportsService redNosedReportsService = mock(RedNosedReportsService.class);

    private final RedNosedReportsRequestHandler functionRequestHandler =
            new RedNosedReportsRequestHandler(objectMapper, redNosedReportsService);
    ...
    void testExecute_Success() throws IOException {
        ...
        when(redNosedReportsService.solve("testInput")).thenReturn(solutionJson);
        ...
        verify(redNosedReportsService).solve("testInput");
        verify(objectMapper).writeValueAsString(solutionJson);
        verifyNoMoreInteractions(objectMapper, redNosedReportsService);
    }
    ...
    void testExecute_MissingRequestBody() {
        ...
        verifyNoInteractions(objectMapper, redNosedReportsService);
    }
    ...
    void testExecute_MalformedInputJson() throws IOException {
        ...
        verify(redNosedReportsService, never()).solve(anyString());
